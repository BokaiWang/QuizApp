...
class ViewController: UIViewController, QuizProtocol, UITableViewDelegate, UITableViewDataSource, ResultViewControllerProtocol {
    ...
    func displayQuestion() {
        ...
        // It is going to ask again what to show
    ...
    func questionRetrieved(_ questions: [Question]) {
        ...
        if savedIndex != nil && savedIndex! < self.questions.count {
            ...
            // Set the current question to the savedIndex
            currentQuestionIndex = savedIndex!
            
            // Retrieve the number of correct from storage
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if label != nil {
            ...
            if question.answers != nil && indexPath.row < question.answers!.count {
                ...
                // That is, display the answer text
    ...
    // MARK: - When the user taps on an answer
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        
        var titleText = ""
        
        // The user has tapped on a row, check if it's the right answer
        let question = questions[currentQuestionIndex]
        ...
        if resultDialog != nil {
            ...
            /* We can't directly use resultDialog!.textLabel.text = titleText, because the titleLabel hasn't been loaded into memory */
